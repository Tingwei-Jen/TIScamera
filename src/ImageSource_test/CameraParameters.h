...
namespace vbtracker {
    ...
    inline CameraParameters getHDKCameraParameters() {
        ...
        */
        ...
        // coefficients.
#if 0  // HDK original Camera parameters
        ...
        double p1 = 0;
        double p2 = 0;
#else  // Camera parameters by gpd Camera

        std::string filename = "Camera_Parameter.yml";
        cv::FileStorage fs;
        fs.open(filename, cv::FileStorage::READ);

        double fx, k1, k2, k3, p1, p2;
        fx = (double) fs["fx"];
        k1 = (double) fs["k1"];
        k2 = (double) fs["k2"];
        k3 = (double) fs["k3"];
		...
		/*double fx = 9.7423190862235663e+002;
		double k1 = -3.8735583247643107e-001;
		double k2 = 4.2235624628257162e-001;
		double k3 = -1.0639480534054999e+000;
		double p1 = -1.4155734856463203e-003;
		double p2 = 2.2203499037531547e-003;*/
